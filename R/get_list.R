...
#' Queries can be input with the desired `parameter` to find all the
...
#'
#' @param parameter The parameter for the station request. Defaults to
#'   "Water Course Level".
...
#' \dontrun{
#' get_station_list(parameter = "Water Course Discharge")
#' }
...
#' }
#' @export
get_station_list <- function(parameter = "Water Course Level", # water_course_level,
                             station_number = NULL,
                             bbox = NULL,
...
get_data_owner <- function(parameter, station_number) {
